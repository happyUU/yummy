    ...
    <div style="height: 400px">
        ...
        <div style="margin-top:40px;margin-left:400px;">
            <table cellspacing="15" >
                ...
                <tr>
                    <td><p style="font-size: 18px">单价：</p></td>
                    <td><p style="font-size: 18px;font-weight: bold">￥${sessionScope.food.disprice}.00</p></td>
                </tr>

                <tr>
                    <td><p style="font-size: 18px">销量：</p></td>
                    <td><p style="font-size: 18px">累计出售 <span>10000+</span> 件</p></td>
                </tr>
                ...
                <tr>
                    <td> <p style="font-size: 18px">数量：</p></td>
                    <td><p style="font-size: 18px">库存100000</p></td>
                </tr>
                <tr>
